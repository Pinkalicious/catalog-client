...
def execute_commands(the_command, the_args):
    ...
    #Tested
    ...
    elif(the_command=='query_dataset_name'):
        #@arg[0] - catalog_id -- INT
        #@arg[1] - regexp search
        ...
        for dataset in cur_datasets:
            ...
            #print dataset
            try:
                match = re.findall(the_args[1],dataset['name'])
                if(match):
                    #print dataset
        ...
        if print_text == True:
            ...
            for matching_dataset in matching_datasets:
                ...
                try:
                    dataset_labels = ','.join(matching_dataset['label'])
                except:
                    dataset_labels = 'no labels'
                ...
                #print dataset
                print "%s) %s - [%s] - <%s>"%(matching_dataset['id'],dataset_name,matching_dataset['owner'],dataset_labels)
        else:
            print json.dumps(matching_datasets)        
        return True
...
if __name__ == "__main__":
    ...
    command_list = ("get_catalogs","get_dataset_members","write_token",
                    ...
                    "get_annotation_defs","query_dataset_name")
